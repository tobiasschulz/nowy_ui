export function table_size_update(wrapper: HTMLDivElement, table: HTMLTableElement, thead: HTMLTableSectionElement, tbody: HTMLTableSectionElement, tfoot: HTMLTableSectionElement) {
  ...
  */
  ...
  let offset_parent_element = <HTMLElement>wrapper.offsetParent;
...
export function table_size_info(wrapper: HTMLDivElement, table: HTMLTableElement, thead: HTMLTableSectionElement, tbody: HTMLTableSectionElement, tfoot: HTMLTableSectionElement) {
  let height_wrapper = Number(String(window.getComputedStyle(wrapper, null).height).slice(0, -2));
  let height_table = Number(String(window.getComputedStyle(table, null).height).slice(0, -2));
  let height_thead = Number(String(window.getComputedStyle(thead, null).height).slice(0, -2));
  let height_tbody = Number(String(window.getComputedStyle(tbody, null).height).slice(0, -2));
